...
module impix_system_mm_interconnect_0 (
	...
	wire   [31:0] switches_input_s1_agent_m0_readdata;                               // switches_input_s1_translator:uav_readdata -> switches_input_s1_agent:m0_readdata
	wire          switches_input_s1_agent_m0_waitrequest;                            // switches_input_s1_translator:uav_waitrequest -> switches_input_s1_agent:m0_waitrequest
	wire          switches_input_s1_agent_m0_debugaccess;                            // switches_input_s1_agent:m0_debugaccess -> switches_input_s1_translator:uav_debugaccess
	wire   [29:0] switches_input_s1_agent_m0_address;                                // switches_input_s1_agent:m0_address -> switches_input_s1_translator:uav_address
	wire    [3:0] switches_input_s1_agent_m0_byteenable;                             // switches_input_s1_agent:m0_byteenable -> switches_input_s1_translator:uav_byteenable
	wire          switches_input_s1_agent_m0_read;                                   // switches_input_s1_agent:m0_read -> switches_input_s1_translator:uav_read
	wire          switches_input_s1_agent_m0_readdatavalid;                          // switches_input_s1_translator:uav_readdatavalid -> switches_input_s1_agent:m0_readdatavalid
	wire          switches_input_s1_agent_m0_lock;                                   // switches_input_s1_agent:m0_lock -> switches_input_s1_translator:uav_lock
	wire   [31:0] switches_input_s1_agent_m0_writedata;                              // switches_input_s1_agent:m0_writedata -> switches_input_s1_translator:uav_writedata
	wire          switches_input_s1_agent_m0_write;                                  // switches_input_s1_agent:m0_write -> switches_input_s1_translator:uav_write
	wire    [2:0] switches_input_s1_agent_m0_burstcount;                             // switches_input_s1_agent:m0_burstcount -> switches_input_s1_translator:uav_burstcount
	wire          switches_input_s1_agent_rf_source_valid;                           // switches_input_s1_agent:rf_source_valid -> switches_input_s1_agent_rsp_fifo:in_valid
	wire  [125:0] switches_input_s1_agent_rf_source_data;                            // switches_input_s1_agent:rf_source_data -> switches_input_s1_agent_rsp_fifo:in_data
	wire          switches_input_s1_agent_rf_source_ready;                           // switches_input_s1_agent_rsp_fifo:in_ready -> switches_input_s1_agent:rf_source_ready
	wire          switches_input_s1_agent_rf_source_startofpacket;                   // switches_input_s1_agent:rf_source_startofpacket -> switches_input_s1_agent_rsp_fifo:in_startofpacket
	wire          switches_input_s1_agent_rf_source_endofpacket;                     // switches_input_s1_agent:rf_source_endofpacket -> switches_input_s1_agent_rsp_fifo:in_endofpacket
	wire          switches_input_s1_agent_rsp_fifo_out_valid;                        // switches_input_s1_agent_rsp_fifo:out_valid -> switches_input_s1_agent:rf_sink_valid
	wire  [125:0] switches_input_s1_agent_rsp_fifo_out_data;                         // switches_input_s1_agent_rsp_fifo:out_data -> switches_input_s1_agent:rf_sink_data
	wire          switches_input_s1_agent_rsp_fifo_out_ready;                        // switches_input_s1_agent:rf_sink_ready -> switches_input_s1_agent_rsp_fifo:out_ready
	wire          switches_input_s1_agent_rsp_fifo_out_startofpacket;                // switches_input_s1_agent_rsp_fifo:out_startofpacket -> switches_input_s1_agent:rf_sink_startofpacket
	wire          switches_input_s1_agent_rsp_fifo_out_endofpacket;                  // switches_input_s1_agent_rsp_fifo:out_endofpacket -> switches_input_s1_agent:rf_sink_endofpacket
	wire          switches_input_s1_agent_rdata_fifo_src_valid;                      // switches_input_s1_agent:rdata_fifo_src_valid -> switches_input_s1_agent_rdata_fifo:in_valid
	wire   [33:0] switches_input_s1_agent_rdata_fifo_src_data;                       // switches_input_s1_agent:rdata_fifo_src_data -> switches_input_s1_agent_rdata_fifo:in_data
	wire          switches_input_s1_agent_rdata_fifo_src_ready;                      // switches_input_s1_agent_rdata_fifo:in_ready -> switches_input_s1_agent:rdata_fifo_src_ready
	...
	wire  [124:0] pio_0_s1_agent_rp_data;                                            // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire          switches_input_s1_agent_rp_valid;                                  // switches_input_s1_agent:rp_valid -> router_005:sink_valid
	wire  [124:0] switches_input_s1_agent_rp_data;                                   // switches_input_s1_agent:rp_data -> router_005:sink_data
	wire          switches_input_s1_agent_rp_ready;                                  // router_005:sink_ready -> switches_input_s1_agent:rp_ready
	wire          switches_input_s1_agent_rp_startofpacket;                          // switches_input_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          switches_input_s1_agent_rp_endofpacket;                            // switches_input_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          switches_input_s1_burst_adapter_source0_valid;                     // switches_input_s1_burst_adapter:source0_valid -> switches_input_s1_agent:cp_valid
	wire  [124:0] switches_input_s1_burst_adapter_source0_data;                      // switches_input_s1_burst_adapter:source0_data -> switches_input_s1_agent:cp_data
	wire          switches_input_s1_burst_adapter_source0_ready;                     // switches_input_s1_agent:cp_ready -> switches_input_s1_burst_adapter:source0_ready
	wire    [3:0] switches_input_s1_burst_adapter_source0_channel;                   // switches_input_s1_burst_adapter:source0_channel -> switches_input_s1_agent:cp_channel
	wire          switches_input_s1_burst_adapter_source0_startofpacket;             // switches_input_s1_burst_adapter:source0_startofpacket -> switches_input_s1_agent:cp_startofpacket
	wire          switches_input_s1_burst_adapter_source0_endofpacket;               // switches_input_s1_burst_adapter:source0_endofpacket -> switches_input_s1_agent:cp_endofpacket
	...
	wire          router_004_src_valid;                                              // router_004:src_valid -> pio_0_s1_rsp_width_adapter:in_valid
	wire  [124:0] router_004_src_data;                                               // router_004:src_data -> pio_0_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                              // pio_0_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [3:0] router_004_src_channel;                                            // router_004:src_channel -> pio_0_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                      // router_004:src_startofpacket -> pio_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                        // router_004:src_endofpacket -> pio_0_s1_rsp_width_adapter:in_endofpacket
	wire          pio_0_s1_rsp_width_adapter_src_valid;                              // pio_0_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [160:0] pio_0_s1_rsp_width_adapter_src_data;                               // pio_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          pio_0_s1_rsp_width_adapter_src_ready;                              // rsp_demux_002:sink_ready -> pio_0_s1_rsp_width_adapter:out_ready
	wire    [3:0] pio_0_s1_rsp_width_adapter_src_channel;                            // pio_0_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          pio_0_s1_rsp_width_adapter_src_startofpacket;                      // pio_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          pio_0_s1_rsp_width_adapter_src_endofpacket;                        // pio_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          router_005_src_valid;                                              // router_005:src_valid -> switches_input_s1_rsp_width_adapter:in_valid
	wire  [124:0] router_005_src_data;                                               // router_005:src_data -> switches_input_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                              // switches_input_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [3:0] router_005_src_channel;                                            // router_005:src_channel -> switches_input_s1_rsp_width_adapter:in_channel
	wire          router_005_src_startofpacket;                                      // router_005:src_startofpacket -> switches_input_s1_rsp_width_adapter:in_startofpacket
	wire          router_005_src_endofpacket;                                        // router_005:src_endofpacket -> switches_input_s1_rsp_width_adapter:in_endofpacket
	wire          switches_input_s1_rsp_width_adapter_src_valid;                     // switches_input_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [160:0] switches_input_s1_rsp_width_adapter_src_data;                      // switches_input_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          switches_input_s1_rsp_width_adapter_src_ready;                     // rsp_demux_003:sink_ready -> switches_input_s1_rsp_width_adapter:out_ready
	wire    [3:0] switches_input_s1_rsp_width_adapter_src_channel;                   // switches_input_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          switches_input_s1_rsp_width_adapter_src_startofpacket;             // switches_input_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          switches_input_s1_rsp_width_adapter_src_endofpacket;               // switches_input_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                             // cmd_mux_002:src_valid -> pio_0_s1_cmd_width_adapter:in_valid
	wire  [160:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> pio_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                             // pio_0_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> pio_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                     // cmd_mux_002:src_startofpacket -> pio_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                       // cmd_mux_002:src_endofpacket -> pio_0_s1_cmd_width_adapter:in_endofpacket
	wire          pio_0_s1_cmd_width_adapter_src_valid;                              // pio_0_s1_cmd_width_adapter:out_valid -> pio_0_s1_burst_adapter:sink0_valid
	wire  [124:0] pio_0_s1_cmd_width_adapter_src_data;                               // pio_0_s1_cmd_width_adapter:out_data -> pio_0_s1_burst_adapter:sink0_data
	wire          pio_0_s1_cmd_width_adapter_src_ready;                              // pio_0_s1_burst_adapter:sink0_ready -> pio_0_s1_cmd_width_adapter:out_ready
	wire    [3:0] pio_0_s1_cmd_width_adapter_src_channel;                            // pio_0_s1_cmd_width_adapter:out_channel -> pio_0_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_003_src_valid;                                             // cmd_mux_003:src_valid -> switches_input_s1_cmd_width_adapter:in_valid
	wire  [160:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> switches_input_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                             // switches_input_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                           // cmd_mux_003:src_channel -> switches_input_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                     // cmd_mux_003:src_startofpacket -> switches_input_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                       // cmd_mux_003:src_endofpacket -> switches_input_s1_cmd_width_adapter:in_endofpacket
	wire          switches_input_s1_cmd_width_adapter_src_valid;                     // switches_input_s1_cmd_width_adapter:out_valid -> switches_input_s1_burst_adapter:sink0_valid
	wire  [124:0] switches_input_s1_cmd_width_adapter_src_data;                      // switches_input_s1_cmd_width_adapter:out_data -> switches_input_s1_burst_adapter:sink0_data
	wire          switches_input_s1_cmd_width_adapter_src_ready;                     // switches_input_s1_burst_adapter:sink0_ready -> switches_input_s1_cmd_width_adapter:out_ready
	wire    [3:0] switches_input_s1_cmd_width_adapter_src_channel;                   // switches_input_s1_cmd_width_adapter:out_channel -> switches_input_s1_burst_adapter:sink0_channel
	wire          switches_input_s1_cmd_width_adapter_src_startofpacket;             // switches_input_s1_cmd_width_adapter:out_startofpacket -> switches_input_s1_burst_adapter:sink0_startofpacket
	wire          switches_input_s1_cmd_width_adapter_src_endofpacket;               // switches_input_s1_cmd_width_adapter:out_endofpacket -> switches_input_s1_burst_adapter:sink0_endofpacket
	...
	wire          switches_input_s1_agent_rdata_fifo_out_valid;                      // switches_input_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] switches_input_s1_agent_rdata_fifo_out_data;                       // switches_input_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          switches_input_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_003:in_0_ready -> switches_input_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                 // avalon_st_adapter_003:out_0_valid -> switches_input_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                  // avalon_st_adapter_003:out_0_data -> switches_input_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                 // switches_input_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                 // avalon_st_adapter_003:out_0_error -> switches_input_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) switches_input_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (switches_input_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (switches_input_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (switches_input_s1_agent_m0_read),               //                         .read
		.uav_write              (switches_input_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (switches_input_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (switches_input_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (switches_input_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (switches_input_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (switches_input_s1_agent_m0_writedata),          //                         .writedata
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) switches_input_s1_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (switches_input_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (switches_input_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (switches_input_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (switches_input_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (switches_input_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (switches_input_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (switches_input_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (switches_input_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (switches_input_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (switches_input_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (switches_input_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (switches_input_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (switches_input_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (switches_input_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (switches_input_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (switches_input_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (switches_input_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (switches_input_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (switches_input_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (switches_input_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (switches_input_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (switches_input_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (switches_input_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (switches_input_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (switches_input_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (switches_input_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (switches_input_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (switches_input_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (switches_input_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (switches_input_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (switches_input_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (switches_input_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (switches_input_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (switches_input_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (switches_input_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) switches_input_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                      //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (switches_input_s1_agent_rf_source_data),             //        in.data
		.in_valid          (switches_input_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (switches_input_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (switches_input_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (switches_input_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (switches_input_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (switches_input_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (switches_input_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (switches_input_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (switches_input_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                              // (terminated)
		.csr_read          (1'b0),                                               // (terminated)
		.csr_write         (1'b0),                                               // (terminated)
		.csr_readdata      (),                                                   // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) switches_input_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (switches_input_s1_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (switches_input_s1_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (switches_input_s1_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (switches_input_s1_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (switches_input_s1_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (switches_input_s1_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	impix_system_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (switches_input_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (switches_input_s1_agent_rp_valid),              //          .valid
		.sink_data          (switches_input_s1_agent_rp_data),               //          .data
		.sink_startofpacket (switches_input_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (switches_input_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) switches_input_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                         //       cr0.clk
		.reset                 (jtag_uart_0_reset_reset_bridge_in_reset_reset),         // cr0_reset.reset
		.sink0_valid           (switches_input_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (switches_input_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (switches_input_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (switches_input_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (switches_input_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (switches_input_s1_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (switches_input_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (switches_input_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (switches_input_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (switches_input_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (switches_input_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (switches_input_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	impix_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.sink_ready         (switches_input_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (switches_input_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (switches_input_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (switches_input_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (switches_input_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (switches_input_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) switches_input_s1_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                         //       clk.clk
		.reset                (jtag_uart_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		...
		.out_endofpacket      (switches_input_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (switches_input_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (switches_input_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (switches_input_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (switches_input_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (switches_input_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                 // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) switches_input_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                         //       clk.clk
		.reset                (jtag_uart_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		...
		.out_endofpacket      (switches_input_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (switches_input_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (switches_input_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (switches_input_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (switches_input_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (switches_input_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                 // (terminated)
	);
	...
	impix_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (switches_input_s1_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (switches_input_s1_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (switches_input_s1_agent_rdata_fifo_out_ready),  //         .ready
