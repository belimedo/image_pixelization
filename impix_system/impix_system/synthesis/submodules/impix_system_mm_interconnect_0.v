...
module impix_system_mm_interconnect_0 (
	...
	wire  [122:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                       // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [122:0] sysid_qsys_0_control_slave_agent_rp_data;                          // sysid_qsys_0_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [122:0] router_002_src_data;                                               // router_002:src_data -> jtag_uart_0_avalon_jtag_slave_rsp_width_adapter:in_data
	...
	wire  [158:0] jtag_uart_0_avalon_jtag_slave_rsp_width_adapter_src_data;          // jtag_uart_0_avalon_jtag_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [122:0] router_003_src_data;                                               // router_003:src_data -> sysid_qsys_0_control_slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                              // sysid_qsys_0_control_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                            // router_003:src_channel -> sysid_qsys_0_control_slave_rsp_width_adapter:in_channel
	...
	wire  [158:0] sysid_qsys_0_control_slave_rsp_width_adapter_src_data;             // sysid_qsys_0_control_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [158:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> jtag_uart_0_avalon_jtag_slave_cmd_width_adapter:in_data
	...
	wire  [122:0] jtag_uart_0_avalon_jtag_slave_cmd_width_adapter_src_data;          // jtag_uart_0_avalon_jtag_slave_cmd_width_adapter:out_data -> jtag_uart_0_avalon_jtag_slave_burst_adapter:sink0_data
	...
	wire  [158:0] cmd_mux_001_src_data;                                              // cmd_mux_001:src_data -> sysid_qsys_0_control_slave_cmd_width_adapter:in_data
	...
	wire  [122:0] sysid_qsys_0_control_slave_cmd_width_adapter_src_data;             // sysid_qsys_0_control_slave_cmd_width_adapter:out_data -> sysid_qsys_0_control_slave_burst_adapter:sink0_data
